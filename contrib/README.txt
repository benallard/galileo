...
``galileo.service``
  ...
  created for the Gentoo package and will likely need customization
  for other distributions. In particular, the user and group that the
  daemon runs as, as well as the location of the configuration file,
  may need to be changed.

  This service unit file should be installed into the
