...
class testDM(unittest.TestCase):
    ...
    def testAsList(self):
        ...
        self.assertEqual(msg.asList(), bytearray(b'\x00\x01\x02\x03\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05'))
